...
export const Navbar = () => {
    ...
    const NavItem = ({ title, path, dropdownItems = null }) => {
        ...
        return (
            ...
            >
                <Link
                    to={targetPath}
                    className="px-3 py-2 text-gray-700 font-medium hover:text-blue-600 transition-colors flex items-center h-full gap-1"
                >
                    {title}
                    {isDropdown && (
    ...
    const MobileNavItem = ({ title, path, dropdownItems = null }) => {
        ...
        return (
            <div className="border-l-4 border-transparent hover:border-[#2b7fff]">
                <Link
                    to={path}
                    onClick={handleToggle}
                    className="flex justify-between items-center px-6 py-3 hover:bg-gray-50 text-gray-700 font-medium transition-colors w-full"
                >
                    {title}
                    {isDropdown && (
    ...
    return (
        <header className="w-full shadow-md font-sans">
            {/* Top Utility Bar */}
            <div className="bg-[#2b7fff] text-white h-10 px-6 md:px-16 lg:px-24 flex items-center justify-between text-sm">
            ...
            <div className="bg-white h-20 relative">
                <div className="container mx-auto h-full px-6 md:px-16 lg:px-24 flex items-center justify-between">
                    ...
                    <nav className="hidden lg:flex items-center h-full space-x-1 pl-8">
                        ...
                        <NavItem title="Our Team" path={navigationPaths.OurTeam} />
                        ...
                        <NavItem title="Career" path={navigationPaths.Career} />
            ...
            <div className={`lg:hidden bg-white border-t border-gray-100 absolute w-full z-40 transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'max-h-screen opacity-100 shadow-xl' : 'max-h-0 opacity-0 overflow-hidden'}`}>
                <div className="flex flex-col py-2 overflow-y-auto max-h-[calc(100vh-120px)]">
                    ...
                    <MobileNavItem title="Our Team" path={navigationPaths.OurTeam} />
                    ...
                    <MobileNavItem title="Career" path={navigationPaths.Career} />
